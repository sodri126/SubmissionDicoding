...
class TvShowFavoriteFragment : Fragment() {
    ...
    private val mainAdapter by lazy { MainAdapter<FavoriteTvShow>() }
    ...
    private fun fetchDataAndLiveData() {
        mainViewModel.getListTvFavorite()

        mainViewModel.favoriteTvLiveData().observe(this, Observer {
            it?.apply {
                mainAdapter.movies = this as ArrayList<FavoriteTvShow>
